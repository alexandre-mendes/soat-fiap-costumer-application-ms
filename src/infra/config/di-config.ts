...
import { DefaultFindCostumerByCpfUseCase } from "../../application/usecase/implementations/query/DefaultFindCostumerByCpfUseCase";
...
const findCostumerByCpfUseCase: FindCostumerByCpfUseCase = new DefaultFindCostumerByCpfUseCase(costumerRepository);
